...
// WP-Optimize advanced-cache.php (written by version: 3.2.21) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'C:\xampp\htdocs\clinicapaolaribeiro\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/clinicapaolaribeiro/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\xampp\htdocs\clinicapaolaribeiro\wp-content\plugins\wp-optimize\cache/extensions');
}
